  ...
  <div class="row">
    <div class="col col-p-4">
      ...
      <div class="col col-p-6">
        ...
        <div class="panel panel-padding">
          <div class=" product">
            <div class="panel-head" style="background-color: #279945;">
              <h2 style="padding: 10px;">T8 LED Tubes (High Quality)</h2>
            </div>
            <div class="panel-body product-body">
      ...
      <a href="https://www.lampshoponline.com/led/led-floodlights.html" style="text-decoration: none;">
        <div class="panel panel-padding">
          <div class=" product">
            <div class="panel-head" style="background-color: #279945;">
              <h2 style="padding: 10px;">LED Emergency Lighting</h2>
            </div>
            <div class="panel-body product-body">
              <img src="https://www.lampshoponline.com/media/catalog/category/LED-Maintained-Emergency-Fitting-Fully-Recessed_1.jpg" alt="" style="height: 140px; width:100%;">
            </div>
          </div>
        </div>
      </a>
    ...
    <div class="col col-p-4">
      ...
      <div class="col col-p-6">
        ...
        <a href="https://www.lampshoponline.com/led/led-ready-fittings.html" style="text-decoration: none;">
          <div class="panel panel-padding">
            <div class=" product">
              <div class="panel-head" style="background-color: #279945;">
                <h2 style="padding: 10px;">LED Ready Fittings</h2>
              </div>
              <div class="panel-body product-body">
                <img src="https://www.lampshoponline.com/media/catalog/category/led-fittings__48914.jpg" alt="" style="height: 140px;">
              </div>
            </div>
          </div>
        </a>
        <a href="https://www.lampshoponline.com/led/led-lowbays.html" style="text-decoration: none;">
          <div class="panel panel-padding">
            <div class=" product">
              <div class="panel-head" style="background-color: #279945;">
                <h2 style="padding: 10px;">LED Lowbays</h2>
              </div>
              <div class="panel-body product-body">
                <img src="https://www.lampshoponline.com/media/catalog/category/LED_Lowbay_copy.jpg" alt="" style="height: 140px;">
              </div>
            </div>
          </div>
        </a>
      ...
      <div class="col col-p-6">
        <a href="https://www.lampshoponline.com/led/led-highbay.html" style="text-decoration: none;">
        <div class="panel panel-padding">
          <div class=" product">
            <div class="panel-head" style="background-color: #279945;">
              <h2 style="padding: 10px;">LED Highbay</h2>
            </div>
            <div class="panel-body product-body">
              <img src="https://www.lampshoponline.com/media/catalog/category/led-highbay__19837.jpg" alt="" style="height: 140px;">
            </div>
          </div>
        </div>
      </a>
      <a href="https://www.lampshoponline.com/led/led-non-corrosive-luminaires.html" style="text-decoration: none;">
        <div class="panel panel-padding">
          <div class=" product">
            <div class="panel-head" style="background-color: #279945;">
              <h2 style="padding: 10px;">LED Luminaires</h2>
            </div>
            <div class="panel-body product-body">
              <img src="https://www.lampshoponline.com/media/catalog/category/non-corrosive_venture_led.jpg" alt="" style="height: 140px;">
            </div>
          </div>
        </div>
      </a>
      <a href="https://www.lampshoponline.com/led/led-2d-lamps.html" style="text-decoration: none;">
        <div class="panel panel-padding">
          <div class=" product">
            <div class="panel-head" style="background-color: #279945;">
              <h2 style="padding: 10px;">LED 2D Lamps</h2>
            </div>
            <div class="panel-body product-body">
              <img src="https://www.lampshoponline.com/media/catalog/category/ge_led_2d_lamp.jpg" alt="" style="height: 140px;">
            </div>
          </div>
        </div>
      </a>
