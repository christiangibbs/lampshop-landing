<?php
  $page = "t8-tubes";
  include('../../components/site-head.php');
 ...
 <style media="screen">
   ...
   .view-all-button {background-color: #ff2828; padding: 10px; border: 0px;}
     .view-all-button:hover {background-color: #ca1616; cursor: pointer;}
...
<section class="products-brands">
  <div class="row">
    <div class="col col-p-8">
      <div class="panel panel-padding">
        <div style="background-color: #808080;" class="panel-heading">
          <h2 style="padding: 10px;">Our Most Popular Products</h2>
        </div>
        <div class="panel-body" style="overflow: hidden; background-color: #9e9e9e;">
          <div class="col col-4">
              ...
              <div class="panel panel-padding">
                <div class="product">
                  <div class="panel-head" style="background-color: #119B3C;">
                    <h2 style="padding: 10px;">T8 Triphosphor Fluorescent Tube 2ft 18W</h2>
                  </div>
                  <div class="panel-body product-body">
                    <img style="width: 100%;" src="https://www.lampshoponline.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/t/8/t8_tube_94615.1324545917.800.800_37637.1362674923.800.800_54923__72706.jpg" alt="">
                    <b>Available in:</b> <br />
                    <div class="col col-1">
              ...
              <div class="panel panel-padding">
                <div class="product">
                  <div class="panel panel-head" style="background-color: #119B3C;">
                    <h2 style="padding: 10px;">T8 Triphosphor Fluorescent Tube 4ft 36W</h2>
                  </div>
          ...
          <div class="col col-4">
            <a href="https://www.lampshoponline.com/f58w-t8-triphosphor-fluorescent-tube-5ft-58w.html">
              <div class="panel panel-padding">
                <div class="product">
                  <div class="panel panel-head" style="background-color: #119B3C;">
                    <h2 style="padding: 10px;">T8 Triphosphor Fluorescent Tube 5ft 58W</h2>
                  </div>
                  <div class="panel-body">
                    <img style="width: 100%;" src="https://www.lampshoponline.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/t/8/t8_tube_94615.1324545917.800.800_37637.1362674923.800.800_54923__72706.jpg" alt="">
                    <b>Available in:</b> <br />
          ...
          <div class="col col-4">
            <a href="https://www.lampshoponline.com/f70w-t8-triphosphor-fluorescent-tube-6ft-70w.html">
              <div class="panel panel-padding">
                <div class="product">
                  <div class="panel panel-head" style="background-color: #119B3C;">
                    <h2 style="padding: 10px;">T8 Triphosphor Fluorescent Tube 6ft 70W</h2>
                  </div>
                  <div class="panel-body">
                    <img style="width: 100%;" src="https://www.lampshoponline.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/t/8/t8_tube_94615.1324545917.800.800_37637.1362674923.800.800_54923__72706.jpg" alt="">
                    <b>Available in:</b> <br />
    ...
    <div class="col col-p-4">
      <div class="panel panel-padding logos">
        <div class="panel-head" style="background-color: #808080;">
          <h2 style="padding: 10px;">
            <i class="fa fa-gbp" aria-hidden="true"></i> Shop By Brand
          </h2>
        </div>
        <div class="col col-1">
          <a href="https://www.lampshoponline.com/fluorescent-tubes/t8-tubes/sylvania-t8-fluorescent-tubes.html">
            <div class="panel-body">
                <img src="../../images/logos/sylvania-logo-c.png" alt="Sylvania Logo">
                <div class="panel-body">
                    Luxline
          ...
          <a href="https://www.lampshoponline.com/fluorescent-tubes/t8-tubes/osram-t8-fluorescent-tubes.html">
            <div class="panel-body">
                <img src="../../images/logos/osram-logo-c.png" alt="Osram Logo">
                <div class="panel-body">
                    Lumilux
          ...
          <a href="https://www.lampshoponline.com/fluorescent-tubes/t8-tubes/ge-t8-fluorescent-tubes.html">
            <div class="panel-body">
                <img src="../../images/logos/ge-logo-c.png" alt="GE Logo" style="width: 25%;">
                <div class="panel-body">
                    Polylux
                </div>
            </div>
          </a>
          <a href="https://www.lampshoponline.com/fluorescent-tubes/t8-tubes/philips-master-tl-d-tubes.html">
            <div class="panel-body">
                <img src="../../images/logos/philips-logo-c.png" alt="Philips Logo">
                <div class="panel-body">
                    TL-D
...
<div class="row">
  <div class="col col-1">
    <button type="submit" title="Search" class="view-all-button" style="width: 100%; margin-top:5px;">
...
<div class="hr"></div>
 ...
 <div class="row row-section">
   ...
   <div class="row" style="overflow-x:">
